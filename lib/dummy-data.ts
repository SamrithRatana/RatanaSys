...
export const orgDepartments = [
  { label: "Accounting & Cashier", id: "1ea40bcd-b285-4405-84be-c5591c62dfd2", desc: "Handles accounting and cashier operations", users: [] },
  { label: "Admin & Stock", id: "687d77fe-dfc1-4380-a1c5-3d2e30b1f42f", desc: "Manages administration and stock", users: [] },
  { label: "Delivery", id: "85c738e2-65ac-4a53-8ad1-2cb6cf43d3b4", desc: "Handles delivery operations", users: [] },
  { label: "IT", id: "843e8109-d4b8-4323-9433-2554e1704e7c", desc: "Manages information technology", users: [] },
  { label: "Marketing", id: "39707d6f-4aba-4f49-8039-68e95b6f5e4e", desc: "Manages marketing and promotions", users: [] },
  { label: "Technical", id: "f1a2b3c4-d5e6-7890-abcd-ef1234567890", desc: "Handles technical operations", users: [] },
] as const;
...
export const userLeaveBalances = [
  { year: "2023", leaveType: "ANNUAL",   credit: 22, used: 19, balance: 3  },
  { year: "2023", leaveType: "HEALTH",   credit: 15, used: 5,  balance: 10 },
  { year: "2023", leaveType: "MATERNITY",credit: 20, used: 8,  balance: 12 },
  { year: "2023", leaveType: "STUDY",    credit: 10, used: 3,  balance: 7  },
  { year: "2023", leaveType: "FAMILY",   credit: 18, used: 6,  balance: 12 },
  { year: "2023", leaveType: "PATERNITY",credit: 12, used: 4,  balance: 8  },
  { year: "2023", leaveType: "UNPAID",   credit: 0,  used: 5,  balance: -5 },
];
